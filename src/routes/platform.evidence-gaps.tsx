  ...
  return (
    <MarketingShell>
      ...
      <section className="marketing-container py-16 md:py-24">
        ...
        <div className="mt-12 rounded-3xl bg-[#EEF3FF] p-8 text-center md:p-12">
          <h2 className="text-3xl font-extrabold tracking-[-0.04em] text-[#0B1020]">Önce hangi kanıtın eksik olduğunu görün.</h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-[#516078]">Ücretsiz ölçüm, herkese açık site verisiyle ilk atıf ve eksik kanıt çerçevenizi oluşturur.</p>
