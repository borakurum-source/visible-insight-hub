      ...
      <article>
        ...
        <section id="metodoloji" className="marketing-container px-4 py-16 md:px-6 md:py-24">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,.88fr)_minmax(380px,1.12fr)]">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <Reveal delay={0.04}><div className="rounded-2xl border border-[#E6EAF2] bg-[#F7F9FC] p-5"><Target className="h-5 w-5 text-[#356AFF]" /><p className="mt-6 font-mono text-4xl text-[#0B1020]">41</p><h3 className="mt-2 font-bold text-[#0B1020]">Sabit soru</h3><p className="mt-2 text-sm leading-6 text-[#667085]">Satın alma niyetli sorgu seti.</p></div></Reveal>
              <Reveal delay={0.08}><div className="rounded-2xl border border-[#E6EAF2] bg-[#F7F9FC] p-5"><LineChart className="h-5 w-5 text-[#356AFF]" /><p className="mt-6 font-mono text-4xl text-[#0B1020]">286</p><h3 className="mt-2 font-bold text-[#0B1020]">Tekrar</h3><p className="mt-2 text-sm leading-6 text-[#667085]">Ağırlıklı orana giren kayıtlar.</p></div></Reveal>
              <Reveal delay={0.12}><div className="rounded-2xl border border-[#E6EAF2] bg-[#F7F9FC] p-5"><TrendingUp className="h-5 w-5 text-emerald-700" /><p className="mt-6 font-mono text-4xl text-[#0B1020]">32</p><h3 className="mt-2 font-bold text-[#0B1020]">Yükselen soru</h3><p className="mt-2 text-sm leading-6 text-[#667085]">Son ölçümde daha yüksek oran.</p></div></Reveal>
              <Reveal delay={0.16}><div className="rounded-2xl border border-[#E6EAF2] bg-[#F7F9FC] p-5"><TrendingDown className="h-5 w-5 text-rose-700" /><p className="mt-6 font-mono text-4xl text-[#0B1020]">7</p><h3 className="mt-2 font-bold text-[#0B1020]">Gerileyen soru</h3><p className="mt-2 text-sm leading-6 text-[#667085]">Ayrı takip listesine alınan alan.</p></div></Reveal>
            </div>
          </div>
        </section>
        ...
        <section className="marketing-container px-4 py-16 md:px-6 md:py-24">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,.95fr)_minmax(360px,1.05fr)] lg:items-center">
            ...
            <Reveal delay={0.08}>
              <aside className="rounded-3xl border border-[#E6EAF2] bg-[#F2F0E8] p-6">
                <p className="text-sm font-semibold text-[#0B1020]">GSC özeti</p>
                <div className="mt-6 grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                  <div className="rounded-2xl border border-[#E6EAF2] bg-[#F7F9FC] p-4"><p className="text-xs text-[#667085]">Toplam gösterim</p><p className="mt-2 font-mono text-3xl text-[#0B1020]">44.613</p><p className="mt-1 text-xs text-[#667085]">87 gün</p></div>
                  <div className="rounded-2xl border border-[#DDE5E4] bg-[#F7F9FC] p-4"><p className="text-xs text-[#667085]">Birleşik Krallık payı</p><p className="mt-2 font-mono text-3xl text-[#0B1020]">89,1%</p></div>
                  <div className="rounded-2xl border border-[#DDE5E4] bg-[#F7F9FC] p-4"><p className="text-xs text-[#667085]">Masaüstü payı</p><p className="mt-2 font-mono text-3xl text-[#0B1020]">80,2%</p></div>
                </div>
              </aside>
            </Reveal>
          </div>
  ...
  return (
    <MarketingShell>
      <article>
        ...
        <header className="border-b border-[#E6EAF2] bg-[#F7F9FC] px-4 py-14 md:px-6 md:py-20">
          <div className="mx-auto max-w-3xl">
            <Link to="/makaleler" className="inline-flex items-center gap-1 text-sm font-bold text-[#356AFF]"><ArrowLeft className="h-4 w-4" /> Tüm makaleler</Link>
            <Badge variant="outline" className="mt-8 border-[#E6EAF2] bg-[#F7F9FC] text-[#356AFF]">{article.category}</Badge>
        ...
        <div className="mx-auto grid max-w-5xl gap-10 px-4 py-16 md:px-6 md:py-24 lg:grid-cols-[minmax(0,1fr)_250px]">
          ...
          <aside className="h-fit rounded-2xl border border-[#E6EAF2] bg-[#F2F0E8] p-5">
