...
function CitationSharePage() {
  return (
    <MarketingShell>
      ...
      >
        <p className="text-sm text-slate-400">Örnek ölçüm yüzeyleri: <EngineRotator className="font-mono text-cyan" /></p>
      </VisualHero>
      ...
      <section className="border-y border-border bg-background px-4 py-16 md:px-6 md:py-24">
        <div className="marketing-container grid gap-10 lg:grid-cols-2">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.14em] text-primary">Nasıl okunur?</p>
            <h2 className="mt-4 text-3xl font-extrabold tracking-[-0.04em] text-foreground md:text-4xl">Kaynak seçimi, rakip varlığı ve niyet aynı tabloda.</h2>
          ...
          <div className="rounded-2xl border border-border bg-secondary p-5">
            ...
            <div className="mt-5 space-y-3">
              ...
              <div className="rounded-xl bg-background p-3 text-sm"><span className="text-muted-foreground">Rakip kaynak</span><p className="mt-1 font-semibold text-foreground">Üçüncü taraf “en iyi ajanslar” listesi</p></div>
            </div>
          </div>
        </div>
      </section>
