    ...
    <MarketingShell>
      ...
      <section className="border-y border-[#E6EAF2] bg-white px-4 py-16 md:px-6 md:py-24">
        <div className="marketing-container grid gap-10 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-[#E6EAF2] bg-[#F7F9FC] p-5">
            ...
            <div className="mt-5 space-y-3">
              <div className="rounded-xl bg-white p-3 text-sm"><span className="text-[#667085]">Seçilen kaynak</span><p className="mt-1 font-semibold text-[#0B1020]">FilmFolk — vaka çalışması</p></div>
              <div className="rounded-xl bg-white p-3 text-sm"><span className="text-[#667085]">Rakip kaynak</span><p className="mt-1 font-semibold text-[#0B1020]">Üçüncü taraf “en iyi ajanslar” listesi</p></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="marketing-container px-4 py-16 md:px-6 md:py-24">
        <div className="rounded-3xl bg-[#EEF3FF] p-8 md:p-12">
          <div className="grid gap-8 lg:grid-cols-[1.2fr_.8fr]">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-[#516078]">Atıf payı düştüğünde soru “hangi içerik yazılmalı?” değildir. Önce Yapay zekanın hangi kanıtı seçtiği veya görmediği belirlenir; aksiyon bunun ardından gelir.</p>
            </div>
            <div className="space-y-3">
              {["Soru bazında ölçüm", "Görünür atıf kanıtı", "Önceliklendirilmiş eksik kanıt"].map((item) => (
                <div key={item} className="flex items-center gap-3 rounded-xl border border-white bg-white p-4 text-sm font-bold text-[#0B1020]"><CheckCircle2 className="h-5 w-5 text-[#356AFF]" />{item}</div>
              ))}
            </div>
          </div>
        </div>
