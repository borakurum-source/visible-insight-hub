...
export const articles: Article[] = [
  ...
  {
    slug: "yapay-zeka-atif-payini-olcmek", category: "Atıf ve kaynak analizi", title: "Yapay zeka AI kaynak payı nasıl ölçülür?", description: "Marka adının geçmesinden fazlasını ölçmek için arama sorusu, seçilen kaynak ve sonuç bağlamını birlikte okuyun.", readingTime: "6 dk okuma", date: "14 Ağustos 2026",
    sections: [
