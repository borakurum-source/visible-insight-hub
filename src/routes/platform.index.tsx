      ...
      <section className="marketing-container px-4 py-16 md:px-6 md:py-24">
        ...
        <div className="mt-12 grid gap-4 lg:grid-cols-3">
          {steps.map(({ icon: Icon, number, label, title, body }) => (
            <article key={number} className="rounded-2xl border border-[#E6EAF2] bg-[#F7F9FC] p-6">
      ...
      <section className="marketing-container px-4 py-16 md:px-6 md:py-24">
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          {modules.map(({ icon: Icon, title, body, href }) => (
            <Link to={href} key={title} className="group rounded-2xl border border-[#E6EAF2] bg-[#F7F9FC] p-6 transition-transform hover:-translate-y-1">
