    ...
    <MarketingShell>
      ...
      >
        <div className="max-w-xl rounded-2xl border border-white/15 bg-white/[0.08] p-4 backdrop-blur-md md:p-5">
          ...
          <div className="[&_button]:border-white [&_button]:bg-white [&_button]:text-[#101211] [&_button]:hover:bg-[#E9F9FD] [&_input]:border-white/20 [&_input]:bg-white [&_input]:text-[#101211] [&_input]:placeholder:text-[#6B6A61]">
