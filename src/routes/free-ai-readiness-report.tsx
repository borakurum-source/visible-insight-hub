  ...
  return (
    <MarketingShell>
      <VisualHero
        ...
        title={<>Markanızın yapay zeka cevaplarında nerede durduğunu <span className="text-[#3FBFB2]">ölçerek başlayın.</span></>}
      ...
      >
        <div className="max-w-xl rounded-2xl border border-white/15 bg-[#FBFAF5]/[0.08] p-4 backdrop-blur-md md:p-5">
          <div className="mb-3 flex items-center gap-2 text-sm font-semibold text-white"><CheckCircle2 className="h-4 w-4 text-[#3FBFB2]" /> Ücretsiz ölçümünüzü başlatın</div>
          <div className="[&_button]:border-white [&_button]:bg-[#FBFAF5] [&_button]:text-[#101211] [&_button]:hover:bg-[#E9F9FD] [&_input]:border-white/20 [&_input]:bg-[#FBFAF5] [&_input]:text-[#101211] [&_input]:placeholder:text-[#6B6A61]">
      ...
      <section className="marketing-container px-4 py-16 md:px-6 md:py-24">
        <div className="max-w-2xl">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#1B7F86]">Raporun içinden</p>
          <h2 className="mt-4 text-3xl font-extrabold tracking-[-0.04em] text-[#101211] md:text-5xl">Bir skor değil, neyi incelemeniz gerektiğini gösteren başlangıç noktası.</h2>
          <p className="mt-5 text-base leading-7 text-[#6B6A61]">Ücretsiz rapor, tam platform analizi yerine ilk doğrulanabilir çerçeveyi sunar. Düzenli takip için soru, kaynak ve eksik kanıt çalışma alanına geçebilirsiniz.</p>
        </div>
      ...
      <section className="border-y border-[#E3E0D5] bg-[#FBFAF5] px-4 py-16 md:px-6 md:py-24">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#1B7F86]">Doğru beklenti</p>
          <h2 className="mt-4 text-3xl font-extrabold tracking-[-0.04em] text-[#101211] md:text-4xl">Bu bir görünürlük garantisi değildir.</h2>
          <p className="mt-5 text-base leading-7 text-[#6B6A61]">Yapay zeka yanıtları model, zaman, soru bağlamı ve web kaynaklarıyla değişebilir. OneCite’ın rolü belirsizliği gizlemek değil; ölçülebilir kanıt ve uygulama alanını görünür kılmaktır.</p>
        </div>
      </section>
    </MarketingShell>
  );
