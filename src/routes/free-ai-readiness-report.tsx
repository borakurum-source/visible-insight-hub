    ...
    <MarketingShell>
      ...
      >
        <div className="max-w-xl rounded-2xl border border-white/15 bg-white/[0.08] p-4 backdrop-blur-md md:p-5">
          ...
          <div className="[&_button]:border-white [&_button]:bg-white [&_button]:text-[#0B1020] [&_button]:hover:bg-[#E9F9FD] [&_input]:border-white/20 [&_input]:bg-white [&_input]:text-[#0B1020] [&_input]:placeholder:text-[#667085]">
      ...
      <section className="marketing-container px-4 py-16 md:px-6 md:py-24">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-3">
          {outputs.map(({ icon: Icon, title, body }) => (
            <article key={title} className="rounded-2xl border border-[#E6EAF2] bg-white p-6">
