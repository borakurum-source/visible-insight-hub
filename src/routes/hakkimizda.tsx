  ...
  return (
    <MarketingShell>
      <VisualHero
        ...
        title={<>Yapay zeka cevaplarında <span className="text-[#3FBFB2]">kaynak</span> olarak seçilmek, artık ölçülebilir bir problem.</>}
      ...
      <section id="neden" className="marketing-container py-16 md:py-24">
        <div className="grid gap-10 lg:grid-cols-[.86fr_1.14fr] lg:items-start">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#1B7F86]">Problem</p>
            <h2 className="mt-4 text-3xl font-extrabold tracking-[-0.04em] text-[#101211] md:text-5xl">Arama sonucu ile AI cevabı aynı görünürlük değildir.</h2>
          </div>
          <div className="space-y-5 text-base leading-8 text-[#57564E]">
            ...
            <blockquote className="border-l-2 border-[#3FBFB2] pl-5 text-xl font-semibold leading-8 text-[#101211]">“Bir markanın AI cevaplarında nerede durduğunu tahmin etmeyin. Soruyu, kaynağı ve eksik kanıtı aynı anda görün.”</blockquote>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-[#E3E0D5] bg-[#FBFAF5] px-4 py-16 md:px-6 md:py-24">
        <div className="marketing-container">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl font-extrabold tracking-[-0.04em] text-[#101211] md:text-5xl">Görsel merak uyandırır; kanıt güven verir.</h2>
          </div>
          <div className="mt-12 grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl border border-[#E3E0D5] bg-[#FBFAF5] p-6"><Network className="h-5 w-5 text-[#1B7F86]" /><p className="mt-7 font-mono text-xs text-[#6B6A61]">01 / CONTEXT</p><h3 className="mt-3 text-xl font-extrabold text-[#101211]">Bağlamı kur</h3><p className="mt-3 text-sm leading-6 text-[#6B6A61]">Marka, domain, hedef pazar, dil ve satın alma niyetli soruları aynı çalışma çerçevesinde tanımla.</p></article>
            <article className="rounded-2xl border border-[#E3E0D5] bg-[#FBFAF5] p-6"><CircleDotDashed className="h-5 w-5 text-[#3FBFB2]" /><p className="mt-7 font-mono text-xs text-[#6B6A61]">02 / EVIDENCE</p><h3 className="mt-3 text-xl font-extrabold text-[#101211]">Kaynak sinyalini gör</h3><p className="mt-3 text-sm leading-6 text-[#6B6A61]">AI cevabında seçilen kaynakları, atıf payını ve görünürlüğü kesen evidence gap’leri ilişkilendir.</p></article>
            <article className="rounded-2xl border border-[#E3E0D5] bg-[#FBFAF5] p-6"><Sparkles className="h-5 w-5 text-[#1B7F86]" /><p className="mt-7 font-mono text-xs text-[#6B6A61]">03 / ACTION</p><h3 className="mt-3 text-xl font-extrabold text-[#101211]">Sonraki kararı seç</h3><p className="mt-3 text-sm leading-6 text-[#6B6A61]">Eksik kanıtı içerik, kaynak veya ölçüm aksiyonuna çevir; sonucu aynı soru bağlamında yeniden izle.</p></article>
          </div>
        </div>
      </section>
      ...
      <section className="marketing-container py-16 md:py-24">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
          <div className="rounded-3xl bg-[#101211] p-7 text-white md:p-10">
            <p className="visual-source-label text-[#3FBFB2]">MEASUREMENT BOUNDARY</p>
          ...
          <div className="rounded-3xl border border-[#E3E0D5] bg-[#FBFAF5] p-7 md:p-10">
            ...
            <a href="https://borakurum.com" target="_blank" rel="noreferrer" className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-[#1B7F86] hover:text-[#101211]">Kurucu hikâyesini incele <ExternalLink className="h-4 w-4" /></a>
          </div>
        </div>
      </section>

      <section className="bg-[#F2F0E8] px-4 py-16 text-center md:px-6 md:py-24">
        <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#1B7F86]">Başlangıç</p>
        <h2 className="mx-auto mt-4 max-w-3xl text-3xl font-extrabold tracking-[-0.04em] text-[#101211] md:text-5xl">Markanızın AI cevaplarında nerede durduğunu birlikte görün.</h2>
