  ...
  return (
    <MarketingShell>
      <VisualHero
        ...
        title={<>Müşterinize yalnızca rapor değil, <span className="text-[#3FBFB2]">açıklanabilir yapay zeka görünürlüğü kanıtı</span> götürün.</>}
      ...
      <section className="marketing-container px-4 py-16 md:px-6 md:py-24">
        <div className="max-w-2xl">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#1B7F86]">Ajans çalışma döngüsü</p>
          <h2 className="mt-4 text-3xl font-extrabold tracking-[-0.04em] text-[#101211] md:text-5xl">GEO hizmetini teslim çıktısı değil, ölçülebilir büyüme ritmi yapın.</h2>
          <p className="mt-5 text-base leading-7 text-[#6B6A61]">Her müşterinin alıcısı, kategorisi, rakibi ve eksik kanıt farklıdır. OneCite aynı iş akışını tekrar edilebilir, ancak her müşteri için bağlama duyarlı hale getirir.</p>
        </div>
      ...
      <section className="border-y border-[#E3E0D5] bg-white px-4 py-16 md:px-6 md:py-24">
        <div className="marketing-container grid gap-8 lg:grid-cols-[.9fr_1.1fr]">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-extrabold tracking-[-0.04em] text-[#101211] md:text-4xl">“Neden görünmüyoruz?” sorusuna somut cevap verin.</h2>
            <p className="mt-5 text-base leading-7 text-[#6B6A61]">Marka anılması ile kaynak olarak seçilme arasındaki farkı, rakibin neden seçildiğini ve hangi varlığın eksik kaldığını aynı müşteri görüşmesinde gösterin.</p>
          </div>
          <div className="rounded-2xl bg-[#F5F3EC] p-6">
      ...
      <section className="marketing-container px-4 py-16 text-center md:px-6 md:py-24">
        <h2 className="text-3xl font-extrabold tracking-[-0.04em] text-[#101211] md:text-4xl">Bir müşteri ile başlayın, kanıta dayalı GEO iş akışını görün.</h2>
        <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-[#6B6A61]">İlk ücretsiz ölçüm, gerçek müşteri verisiyle nasıl bir rapor ve uygulama sistemi kurabileceğinizi gösterir.</p>
