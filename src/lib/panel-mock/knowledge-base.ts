...
export interface MockKbSource {
  ...
  chunkCount: number;
  updatedAt: string;
  status: "guncel" | "eski" | "isleniyor";
}

export const mockKbSources: MockKbSource[] = [
  { id: 1, title: "Ürün Sayfası", url: "onecite.com/urun", type: "sayfa", chunkCount: 38, updatedAt: "3 gün önce", status: "guncel" },
  { id: 2, title: "Fiyatlandırma Politikası", url: "onecite.com/fiyatlandirma", type: "sayfa", chunkCount: 12, updatedAt: "12 gün önce", status: "guncel" },
  ...
  { id: 4, title: "Sıkça Sorulan Sorular", url: "onecite.com/sss", type: "sss", chunkCount: 21, updatedAt: "1 gün önce", status: "guncel" },
