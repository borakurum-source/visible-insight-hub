export interface MockGeoTask {
  id: number;
  title: string;
  column: "backlog" | "devam" | "inceleme" | "tamamlandi";
...
export const mockGeoTasks: MockGeoTask[] = [
  ...
  { id: 2, title: "Ürün karşılaştırma içeriğini yayınla", column: "devam", priority: "yuksek", assignee: "Mert K.", dueDate: "15 Tem" },
  { id: 3, title: "Bilgi bankasında eski PDF'i güncelle", column: "inceleme", priority: "dusuk", assignee: "Elif A.", dueDate: "20 Tem" },
  { id: 4, title: "GEO nedir makalesini yayınla", column: "tamamlandi", priority: "yuksek", assignee: "Mert K.", dueDate: "10 Tem" },
];
